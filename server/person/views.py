...
from .serializers import PasswordResetSerializer, PasswordResetVerifiedSerializer, PasswordChangeSerializer
from .permissions import IsStaffOrTargetUser, IsStaffTargetUserOrSafe, IsCreateOrStaffOrTargetUser
...
class UserViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [IsCreateOrStaffOrTargetUser,]
